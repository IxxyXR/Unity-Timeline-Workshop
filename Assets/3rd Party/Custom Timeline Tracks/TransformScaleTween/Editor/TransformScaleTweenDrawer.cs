...
[CustomPropertyDrawer(typeof(TransformScaleTweenBehaviour))]
public class TransformScaleTweenDrawer : PropertyDrawer
{
    ...
    {
        int fieldCount = property.FindPropertyRelative ("tweenType").enumValueIndex == (int)TransformScaleTweenBehaviour.TweenType.Custom ? 6 : 5;
    ...
    public override void OnGUI (Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        if (tweenTypeProp.enumValueIndex == (int)TransformScaleTweenBehaviour.TweenType.Custom)
        {
